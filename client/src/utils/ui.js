...
const GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    colorLight: "var(--gold-light)",
    items: [
      { heading: "Favor tracking", body: "The Favors tab tracks personalized favors for your guests. Each entry records the recipient name, category, size, and two optional fields: Name on Favor (the name or text to print on the favor) and Pre-Printed? (was the name printed before the event?). In the Favor Setup panel, choose which sub-event this favor is distributed at — attendance is then derived automatically from each person's confirmed sub-event attendance in the Guests tab, with no manual entry needed. The Attending column shows Yes, No, or TBD based on whether the person has confirmed attendance at that sub-event." },
      { heading: "Size summary", body: "The Size Totals card at the top gives a breakdown by size code (YS through XXL) so you can send a single order summary to your vendor. TBD sizes are flagged separately." },
    ],
  },
  {
    id: "travel",
