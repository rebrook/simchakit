...
const GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { heading: "Catering Summary", body: "The collapsible Catering Summary card sits between the stat grid and filters. It adapts to your catering style set in Admin Mode: Plated shows a meal choice table (confirmed vs. invited); Buffet with exceptions shows kosher count and dietary flags; Buffet headcount only shows a total count. Meal choice options are configurable in Admin Mode → Guests. The Dietary Requirements list includes anyone flagged Kosher meal required even if they have no separate dietary notes. Use 📋 Copy for caterer to generate a clean plain-text summary." },
  ...
  },
  {
    ...
    items: [
      ...
      { heading: "Timeline", body: "Build the event timeline here, each entry has a title, icon, date, start/end time, venue, an Is Main Event flag, and an Invite all households by default setting. Leave that setting on (the default) for sub-events everyone attends; switch it off for a sub-event only a handful of households attend, like a small rehearsal or a minyan, so on the Guests tab you only need to check the few households who are invited rather than uncheck everyone who is not. Entries switched off show an Opt-in only tag in this list. Timeline entries appear on the Overview tab, the Planning Calendar, and the Print Brief." },
