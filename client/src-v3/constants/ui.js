...
const GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { heading: "Accessing Admin Mode", body: "Click the settings gear in the sidebar footer. Admin Mode is password-protected. The default password is 'admin' -- change it in Admin Mode → Security after setup. Only the event owner can access Admin Mode. Editors and Viewers see the gear button but cannot open the panel." },
