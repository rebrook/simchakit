...
const GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { heading: "Collaborators", body: "Invite others to help plan this event in Admin Mode → Collaborators. Editors get full planning access: they can add guests, manage the budget, update tasks, and more. Viewers get read-only access so family members or coordinators can follow along without making changes. Enter an email address to send an invitation, or use Copy Invite Link to share a link via message. Invitations expire after 7 days. Up to 5 collaborators per event. Collaborators are covered by your purchase at no extra cost -- there is no additional charge to invite co-planners. Collaborator names and email addresses appear in the collaborator list once they have accepted. Events with active collaborators show a collaborator count badge on the event card in the event picker." },
    ],
  },
  {
    id: "dayof",
