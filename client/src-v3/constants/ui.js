...
const GUIDE_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { heading: "Payment schedules", body: "Any expense can carry a payment schedule instead of a single paid checkbox — for example a deposit, a 50% payment, and a balance, each with its own amount, due date, and status. Click the ▾ next to an expense to add, edit, or mark individual payments as paid. Expenses with a payment schedule show a progress bar and a paid-of-total amount instead of the single checkbox, and the CSV export includes total, paid, and remaining amounts for every expense." },
