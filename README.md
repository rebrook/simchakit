...
![Version](https://img.shields.io/badge/version-2.69.4-blue)
...
- **Backup & Restore** — export a full JSON backup (copy to clipboard or download as a file) and restore from any previous backup via Admin Mode → Data
