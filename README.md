...
![Version](https://img.shields.io/badge/version-4.24.0-blue)
...
- **Sub-Event Support** — track attendance across multiple events (service, kiddush, reception); optional per-sub-event RSVP status with row-level chips and dedicated filtering on the Guests tab
